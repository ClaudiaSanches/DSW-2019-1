...
public class TeatroServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for (Promocao promocao : promocoes) {
            buffer = buffer + "<tr><td>"+promocao.getPeça()+"</td><td>"+Float.toString(promocao.getPreco())+"</td><td>"+promocao.getDiahorario()+"</td><td>"+new DynamicSelectBean().getSiteNome(promocao.getSite())+"</td><td>"+new DynamicSelectBean().getTeatroNome(promocao.getTeatro())+"</td></tr>";
        }   
